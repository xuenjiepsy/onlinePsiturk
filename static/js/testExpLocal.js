...
var drawTrajAndJudge = {
  ...
  choices: "NO_KEYS",
  // choices: " ",
  prompt: '<p style="font-size:20px;text-align: center;margin-top: -10px; bold;">if here is a chasing, press "j"; else press "f"<br><strong>Remember to press a key before clicking the mouse.</strong></p>',
  data: {type: 'maintask'},
};
